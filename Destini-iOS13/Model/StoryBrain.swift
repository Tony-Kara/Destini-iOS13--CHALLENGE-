...
struct StoryBrain {
    ...
    func getStoryTitle() -> String {
        return stories[userLocation].title
    }
    
    func getChoice1() -> String {
        return stories[userLocation].choice1
    }
    
    func getChoice2() -> String {
        return stories[userLocation].choice2
    }
    ...
    mutating func nextStory( _ userChoice: String) {
        if userChoice == stories[userLocation].choice1 {
            userLocation = stories[userLocation].choice1Destination
            
        }
        else {
            userLocation = stories[userLocation].choice2Destination
